...
["men", "women", "hours", "pricePerHour", "shuttleCount", "pricePerShuttle"]
    .forEach(id => {
...
document.getElementById("calculateBtn").addEventListener("click", function () {
    ...
    let ok = true;
    const ids = ["men", "women", "hours", "pricePerHour", "shuttleCount", "pricePerShuttle"];
    ...
    document.getElementById("result").innerHTML = `
        ...
        ${men > 0 ? `<b>Tiền mỗi nam:</b> ${perMan.toLocaleString("vi-VN")} đ (x${men})<br>` : ""}
        ${women > 0 ? `<b>Tiền mỗi nữ:</b> ${perWoman.toLocaleString("vi-VN")} đ (x${women})<br>` : ""}

        ${men && women ? `<br><b>Chênh lệch:</b> ${(perMan - perWoman).toLocaleString("vi-VN")} đ` : ""}
    `;
