  ...
  if (men > 0 && women > 0) {
    ...
    document.getElementById("result").innerHTML = `
      ...
      "vi-VN"
        ...
        <b>Tiền mỗi nam:</b> ${perMan.toLocaleString("vi-VN")} đ (x${men})<br>
    ...
    document.getElementById("result").innerHTML = `
      ...
      "vi-VN"
        ...
        <b>Tiền mỗi nam:</b> <b> ${perMan.toLocaleString("vi-VN")} đ <b>(x${men})
    `;
  } else {
    ...
    document.getElementById("result").innerHTML = `
      ...
      "vi-VN"
        ...
        <b>Tiền mỗi nữ:</b> <b>${perWoman.toLocaleString("vi-VN")} đ</b> (x${women})
    `;
  }
